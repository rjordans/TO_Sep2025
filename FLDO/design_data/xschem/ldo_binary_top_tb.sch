...
C {vsource.sym} 570 -490 0 0 {name=Vbias value=1.0 savecurrent=false}
C {lab_pin.sym} 570 -460 0 0 {name=p13 sig_type=std_logic lab=0
value=1.0}
C {lab_pin.sym} 570 -520 0 0 {name=p14 sig_type=std_logic lab=Ibias_1u}
