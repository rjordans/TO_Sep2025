...
C {vsource.sym} 90 -110 0 0 {name=Vcc value="CACE\{vcc\}" savecurrent=false}
...
device=resistor
m=1}
C {ammeter.sym} 1130 -220 3 0 {name=Vload savecurrent=true spice_ignore=0}
C {lab_pin.sym} 440 -250 0 0 {name=p3 lab=enable_n}
C {simulator_commands_shown.sym} 60 -740 0 0 {name=Libs_ngspice1
simulator=ngspice
only_toplevel=false 
value="** IHP models
...
"}
C {simulator_commands_shown.sym} 60 -560 0 0 {name=commands
simulator=ngspice
only_toplevel=false 
...
C {vsource.sym} 440 -220 0 0 {name=V2 value=0 savecurrent=false}
