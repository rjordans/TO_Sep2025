...
set circuit1 [readnet spice $CACE_ROOT/netlist/layout/shifter.spice]
set circuit2 [readnet spice $CACE_ROOT/netlist/schematic/shifter.spice]

lvs "$circuit1 shifter" "$circuit2 shifter" $PDK_ROOT/$PDK/libs.tech/netgen/${PDK}_setup.tcl shifter_comp.out -json
