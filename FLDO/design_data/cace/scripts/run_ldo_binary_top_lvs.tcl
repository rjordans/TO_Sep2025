...
set top "ldo_binary_top"

set circuit1 [readnet spice $CACE_ROOT/netlist/layout/ldo_binary_top.spice]

set circuit2 [readnet spice $PDK_ROOT/$PDK/libs.ref/sg13g2_stdcell/spice/sg13g2_stdcell.spice]
readnet spice $CACE_ROOT/netlist/schematic/ldo_binary_top.spice $circuit2
